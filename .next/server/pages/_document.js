...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1__["default"] {
  static async getInitialProps(ctx) {
    const sheet = new styled_components__WEBPACK_IMPORTED_MODULE_0__.ServerStyleSheet();
    const originalRenderPage = ctx.renderPage;

    const enhanceApp = App => props => sheet.collectStyles( /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx(App, _objectSpread({}, props)));
...
var __webpack_exports__ = __webpack_require__.X(0, [922,859], () => (__webpack_exec__(4001)));
